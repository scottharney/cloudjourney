...
** 
:PROPERTIES: 
:reveal_background: ./ASG-AppMap-slide1.png
...
** 
:PROPERTIES: 
:reveal_background: ./ASG-AppMap-slide2.png
:reveal_background_size: 80%
:reveal_background_trans: slide
:END:
...
** 
:PROPERTIES: 
:reveal_background: ./ASG-AppMap-slide3.png
:reveal_background_size: 80%
:reveal_background_trans: slide
:END:
...
tintri offering lines up with these principles and has "cloud readiness" slides
within their set. pull out and highlight those slides and how key value meshes
with message
